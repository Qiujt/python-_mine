...
r.text  #查看网页内容，默认的文字编码是ISO8859-1
r.encoding         #查看文字编码
r.encoding='utf8'
data = r.text

####################################
r2 = requests.get('https://f10.baidu.com/it/u=1473400516,2677197696&fm=72')
...
#
# •  与GET不同的是,POST请求新增了一个可选参数data,需要通过POST请求传递的body里的数据可以
# 通过data传递
